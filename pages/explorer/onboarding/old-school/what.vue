...
const options = [
    'Basic labour', 'Animal care','House sitting', 'Gardening', 'Technology', 'Interior design'
]
</script>
<template>
    ...
    <div class="flex-1 flex flex-col p-6">
        ...
        <div class="flex-1 flex flex-col justify-start pt-6">
            ...
            <div class="flex-1 flex justify-end items-end mb-6">
                <Button :disabled="!selected.length" @click="navigateTo('/explorer/onboarding/old-school/when')" label="Next" />
            </div>
        </div>
    </div>
</template>
